...
- Download and install Maven: # we add maven repo to our repo list
...
ls /etc/yum.repos.d/
```
- it will search $releasever and it will replace with 6 and 
```
...
- Give the ownership of the directories related to Nexus to the ec2-user: because opt is under root
